...
const Navbar: React.FC = () => {
  ...
  const getRoleGradient = (role: string) => {
    ...
    return (
      gradients[role as keyof typeof gradients] || "from-gray-500 to-gray-600"
    );
  };
            ...
            {navigation.map((item, index) => (
              ...
              >
                <div className="relative z-10 flex items-center space-x-2">
                  <div
                    className={`p-1 rounded-lg bg-gradient-to-br ${item.color} shadow-lg group-hover:scale-110 transition-transform duration-200`}
                  >
                    {item.icon}
                  </div>
            ...
            <div className="relative" onClick={(e) => e.stopPropagation()}>
              ...
              >
                <div className="flex items-center space-x-3 px-2 py-1">
                  <div className="relative">
                    <div
                      className={`h-8 w-8 bg-gradient-to-br ${getRoleGradient(
                        user.role
                  ...
                  <div className="hidden sm:flex flex-col items-start">
                    ...
                    <span
                      className={`text-xs px-2 py-0.5 rounded-full ${getRoleBadgeStyle(
                        user.role
                      )} font-medium`}
                    >
                  ...
                  <div className="p-1">
                    ...
                    <div className="px-4 py-4 border-b border-gray-700/50">
                      <div className="flex items-center space-x-3">
                        <div
                          className={`h-12 w-12 bg-gradient-to-br ${getRoleGradient(
                            user.role
                        ...
                        <div>
                          ...
                          <span
                            className={`inline-block text-xs px-2 py-1 rounded-full ${getRoleBadgeStyle(
                              user.role
                            )} font-medium mt-1`}
                          >
                            {getRoleDisplayName(user.role)}
        ...
        <div className="lg:hidden bg-gradient-to-b from-slate-900/95 to-slate-800/95 backdrop-blur-xl border-t border-gray-700/50 shadow-2xl">
          <div className="px-4 pt-4 pb-6 space-y-2">
            {navigation.map((item, index) => (
              ...
              >
                <div
                  className={`p-2 rounded-lg bg-gradient-to-br ${item.color} shadow-lg group-hover:scale-110 transition-transform duration-200`}
                >
                  {item.icon}
                </div>
