...
export const PulseAnimation: React.FC<PulseAnimationProps> = ({
  ...
  return (
    <div className="relative inline-block">
      <div
        className={`absolute inset-0 ${colorClasses[color]} ${sizeClasses[size]} ${intensityClasses[intensity]} rounded-full opacity-75`}
      />
  ...
  return (
    <div className="relative flex items-center justify-center">
      ...
      <div
        className={`${
          sizeClasses[size]
        } bg-green-500 rounded-full flex items-center justify-center transform transition-all duration-500 ${
