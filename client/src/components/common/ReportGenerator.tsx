          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-purple-50 p-4 rounded-xl">
              ...
              <p className="text-2xl font-bold text-purple-600">
                {(
                  data.reduce((sum, s) => sum + (s.year || 0), 0) / data.length
                ).toFixed(1)}
              </p>
            </div>
          </div>
    ...
    return (
      <div className="text-center py-12">
        ...
        <p className="text-gray-500">
          Configure your report settings and preview will appear here
        </p>
      </div>
    );
  };
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-blue-100 mt-1">
                Create comprehensive reports with charts and analytics
              </p>
            </div>
            <button
              onClick={onClose}
                ...
                {[
                  {
                    ...
                    label: "PDF Report",
                    icon: "📄",
                    desc: "Formatted document with charts",
                  },
                  {
                    value: "excel",
                    label: "Excel Spreadsheet",
                    icon: "📊",
                    desc: "Data in spreadsheet format",
                  },
                  {
                    value: "csv",
                    label: "CSV File",
                ...
                {[
                  ...
                  >
                    <input
                      ...
                      checked={
                        reportConfig[
                          option.key as keyof typeof reportConfig
                        ] as boolean
                      }
                      onChange={(e) =>
